...
if (strtoupper($_SERVER['REQUEST_METHOD']) === 'POST') {
    ...
    if ($unblockedadmincount <= 1 && $_POST['hiddenfield2'] != 0) {
    ...
    if ($stmt = mysqli_prepare($link, $sql)) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            if (!mysqli_stmt_num_rows($stmt) <= 0) {
                ...
                echo "Error 865ads26ß9ß8fsd12";
                die();
            }
        } else {
            echo "Error 86qwz5a26ß9ß8f12";
            die();
        }
    }
        ...
        <div class="app" id="app">
            ...
            <article class="content forms-page">
                <div class="title-block">
                    <h3 class="title"> Admin <?php echo htmlspecialchars($action); ?> </h3>
                </div>
                            ...
                            <div class="card">
                                <div class="card-block">
                                    <div class="card-title-block">
                                        <h4> Möchten Sie den Admin mit den folgenden Daten wirklich <?php echo htmlspecialchars($action); ?>?</h4>
                                    </div>
                                    <section class="example">
                                        ...
                                        echo "<button type=\"button\" class=\"btn btn-info btn\"><a style=\"text-decoration:none; color: white\" href=\"admins.php\">Abbrechen</button>";
                                        ?>

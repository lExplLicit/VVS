...
if (strtoupper($_SERVER['REQUEST_METHOD']) === 'POST') {
    $kurs = (int) htmlspecialchars($_POST['hiddenfield']);
    $sql = "DELETE FROM kurse where kurs_id = " . $kurs . ";";

    if ($stmt = mysqli_prepare($link, $sql)) {
        if (mysqli_stmt_execute($stmt)) {
        } else {
            die("Error 9876544567890332l3456");
        }
    }
    header("location: kurse.php?success=1");
} else {

    $kurs = (int) htmlspecialchars($_GET['kurs']);
    $sql = "SELECT kurs_id, name, studenten, fakultaet FROM kurse WHERE kurs_id = " . $kurs . ";";
    $kurse =  array();
        ...
        <div class="app" id="app">
            ...
            <article class="content forms-page">
                <div class="title-block">
                    <h3 class="title"> Kurs löschen </h3>
                </div>
                            ...
                            <div class="card">
                                <div class="card-block">
                                    <div class="card-title-block">
                                        <h4> Möchten Sie den Kurs mit den folgenden Daten wirklich löschen?</h4>
                                        <br>
                                        <h5 style="color:red">Die Vorlesungen dieses Kurses werden ebenfalls gelöscht!</h5>
                                    </div>
                                    <section class="example">
                                        ...
                                        <br>
                                        <?php
                                        echo "Name: " . htmlspecialchars($kurse[1]['name']) . "<br>";
                                        echo "Anzahl Studenten: " . htmlspecialchars($kurse[1]['studenten']) . "<br>";
                                        echo "Fakultät: " . htmlspecialchars($kurse[1]['fakultaet']) . "<br><br>";
                                        ...
                                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                            ...
                                            <div class="form-group">
                                                <input type="hidden" name="hiddenfield" value="<?php echo (int) $kurse[1]['id']; ?>">

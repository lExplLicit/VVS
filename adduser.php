...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username_err) && empty($password_err) && empty($confirm_password_err) && empty($vorname_err) && empty($nachname_err)) {
        ...
        $sql = "INSERT INTO users (username, password, vorname, nachname, unternehmen) VALUES (?, ?, ?, ? , ?)";
        ...
        <div class="app" id="app">
            ...
            <article class="content forms-page">
                <div class="title-block">
                    <h3 class="title"> Dozenten hinzufügen </h3>
                    <p class="title-description"> Hier können Sie einen Dozenten anlegen. </p>
                </div>

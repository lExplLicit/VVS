...
if (strtoupper($_SERVER['REQUEST_METHOD']) === 'POST') {
    ...
    if ($stmt = mysqli_prepare($link, $sql)) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            echo "Error 865fwerwqea26ß9ß8f12";
        }
    }
        ...
        <div class="app" id="app">
            ...
            <article class="content forms-page">
                <div class="title-block">
                    <h3 class="title"> Dozent löschen </h3>
                </div>
                            ...
                            <div class="card">
                                <div class="card-block">
                                    <div class="card-title-block">
                                        <h4> Möchten Sie den Dozenten mit den folgenden Daten wirklich löschen?</h4>
                                        <br>
                                        <h5 style="color:red">Die Vorlesungen dieses Dozenten werden ebenfalls gelöscht!</h5>
                                    </div>

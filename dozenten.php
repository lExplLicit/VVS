...
if (isset($_GET['search']) && $_GET['search'] != "") {
    ...
    $sql = 'SELECT user_id, username, vorname, nachname, unternehmen, blocked FROM users WHERE admin = 0 AND ((username LIKE \'%' . $searchstring . '%\') OR (vorname LIKE \'%' . $searchstring . '%\') OR (nachname LIKE \'%' . $searchstring . '%\') OR (unternehmen LIKE \'%' . $searchstring . '%\')) ORDER BY nachname ASC;';
        ...
        <div class="app" id="app">
            ...
            <article class="content forms-page">
                <div class="title-block">
                    <h3 class="title"> Dozentenverwaltung </h3>
                    <p class="title-description"> Hier können Sie Dozenten verwalten. </p>
                            ...
                            <div class="card">
                                <div class="card-block">
                                    ...
                                    <section class="example">
                                        <button type="button" class="btn btn-success"><a style="text-decoration:none; color:white" href="adduser.php"> Neuen Dozenten anlegen</a></button> <br><br>
                                                ...
                                                <table class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($users as $user) {
                                                            ...
                                                            echo " <button type=\"button\" class=\"btn btn-warning btn-sm\" ><a style=\"text-decoration:none; color: white\" href=\"blockuser.php?user=" . $user["id"] . "&action=" . $action_key . "\">" . $action . "</button> ";
                                                            echo "<button type=\"button\" class=\"btn btn-danger btn-sm\"><a style=\"text-decoration:none; color: white\" href=\"deluser.php?user=" . $user["id"] . "\">Löschen</button></td>";
                                        ...
                                        <?php } else {
                                        ?>
                                            <h4 style="text-align: center">Es sind noch keine Dozenten vorhanden</h4>
